...
<div id="App">
    ...
    <div class="card">
        <div class="card-body w-100">
            <div class="content-page-header p-0">
                <h5>job (Sous-services)</h5>
                <div class="list-btn">
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#job_modal"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Sous-Services</a>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="card-body">
                            <div class="table-responsive no-pagination">
                                <table class="table table-center table-hover datatable dataTable">
                                    ...
                                    <tbody>
                                        <tr v-for="(f, index) in jobs" :key="index">
                                            <td>@{{ index+1 }}</td>

                                            <td>@{{ f.libelle }}</td>
                                            <td><span v-if="f.nature_job">@{{ f.nature_job.libelle }}</span></td>
                                            <td>@{{ f.description }}</td>
    ...
    <div class="modal custom-modal fade" id="job_modal" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <form  @submit.prevent="createJob" method="POST" action="{{ route("job.create") }}" class="modal-content">

                @csrf
                <div class="modal-header border-0 pb-0">
                    <div class="form-header modal-header-title text-start mb-0">
                        <h4 class="mb-0">Ajouter sous-service</h4>
                    </div>
