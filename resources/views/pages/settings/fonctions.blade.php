    ...
    <div class="card">
        <div class="card-body w-100">
            <div class="content-page-header p-0">
                <h5>Fonctions</h5>
                <div class="list-btn">
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#fonction_modal"><i class="fa fa-plus-circle me-2" aria-hidden="true"></i>+ Fonction</a>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="card-body">
                            <div class="table-responsive no-pagination">
                                <table class="table table-center table-hover datatable">
                                    ...
                                    <tbody>
                                        <tr v-for="(f, index) in fonctions" :key="index">
                                            <td>@{{ index+1 }}</td>
            ...
            <form @submit.prevent="createFonction" method="POST" action="{{ route("fonction.create") }}" class="modal-content">
                ...
                <div class="modal-header border-0 pb-0">
                    <div class="form-header modal-header-title text-start mb-0">
                        <h4 class="mb-0">Ajouter une fonction</h4>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="input-block mb-3">
                                <label>Libellé fonction <span class="text-danger">*</span></label>
                                <input type="text" name="libelle" class="form-control" placeholder="Entrer le libellé fonction">
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="input-block mb-3">
                                <label>Description fonction <span class="text-danger">*</span></label>
