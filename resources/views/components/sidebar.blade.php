        ...
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            <nav class="greedys sidebar-horizantal">
                ...
                <ul class="hidden-links hidden">
                    ...
                    <li>
                        <a href="{{ url('/settings.fonctions') }}"><i class="fe fe-settings"></i> <span>Configurations</span></a>
                    </li>
                    <li>
            ...
            <ul class="sidebar-vertical">
                ...
                <li class="submenu">
                    <a href="#" class><i class="fe fe-user"></i> <span> Super Admin</span> <span
                            class="menu-arrow"></span></a>
                    <ul>
                ...
                <li class="menu-title"><span>Configurations</span></li>
                <li>
                    <a href="{{ url('/settings.fonctions') }}"><i class="fe fe-settings"></i> <span>Configurations</span></a>
                </li>
                <li>
        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <nav class="greedys sidebar-horizantal">
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fe fe-user"></i> <span> Parametres</span> <span class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="dashboard.html">Dashboard</a></li>
                            <li><a href="companies.html">Companies</a></li>
                            <li><a href="subscription.html">Subscription</a></li>
            ...
            <ul class="sidebar-vertical">
               ...
               {{--  <li class="submenu">
                ...
                <li class="menu-title"><span>Parametres</span></li>
                <li>
                    <a href="{{ url('/settings.users') }}"><i class="fe fe-settings"></i> <span>Parametres</span></a>
                </li>
                <li>
                    <a href="login.html"><i class="fe fe-power"></i> <span>Deconnexion</span></a>
                </li>
