<div class="header header-one">
    <a href="index-2.html" class="d-inline-flex d-sm-inline-flex align-items-center d-md-inline-flex d-lg-none align-items-center device-logo">
                            ...
                            <a href="profile.html">
                                <div class="d-flex">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">Lex Murphy</span> requested access to <span class="noti-title">UNIX directory tree
                                                hierarchy</span></p>
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">Ray Arnold</span> left 6 comments <span class="noti-title">on Isla Nublar SOC2 compliance
                                                report</span></p>
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">Dennis Nedry</span> commented on <span class="noti-title"> Isla Nublar SOC2 compliance
                                                report</span></p>
                                        <blockquote>
                        ...
                        <li class="notification-message">
                            <a href="profile.html">
                                <div class="d-flex">
                                    ...
                                    <div class="media-body">
                                        <p class="noti-details"><span class="noti-title">John Hammond</span> created <span class="noti-title">Isla Nublar SOC2 compliance
                                                report</span></p>
