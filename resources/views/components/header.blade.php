<div class="header header-one">
    <a href="#" class="d-inline-flex d-sm-inline-flex align-items-center d-md-inline-flex d-lg-none align-items-center device-logo">
        <img src="{{ asset('assets/img/app-import.jpg') }}" class="img-fluid logo2" alt="Logo" style="width: 50px;">
    </a>
    <div class="main-logo d-inline float-start d-lg-flex align-items-center d-none d-sm-none d-md-none">
        ...
        <div class="logo-color">
            <a href="#">
                <img src="{{ asset('assets/img/app-import.jpg ') }}" class="img-fluid logo-blue" alt="Logo" style="width: 50px;">
            </a>
            <a href="#">
...
<span class="bar-icons"></span>
    ...
    <div class="top-nav-search">
        <form>
            <input type="text" class="form-control" placeholder="Faites une recherche rapide dans waza ">
    ...
    <ul class="nav nav-tabs user-menu">
        ...
        <li class="nav-item dropdown">
            <a href="javascript:void(0)" class="user-link  nav-link" data-bs-toggle="dropdown">
                <span class="user-img">
<img src="assets/img/app-import.jpg" alt="img" class="profilesidebar">
<span class="animate-circle"></span>
                </span>
                <span class="user-content">
                <span class="user-details">{{ Auth::user()->role->libelle }}</span>
