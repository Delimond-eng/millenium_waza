...
VALUES (1, 'LIONNEL', 1, '1679856564', 'nonactif'),
...
VALUES (1, 'MILLENIUM', 1, '1679858110', 'nonactif'),
...
VALUES (1, 'BATEAU', 1, '1679858137', 'nonactif'),
...
VALUES (1, 'LUBUMBASHI', 1, '1679858124', 'nonactif'),
...
VALUES (1, 'COMEXAS', 1, '1679856554', 'nonactif'),
...
--
ALTER TABLE `exportation`
MODIFY `exportation_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 5;
--
...
--
ALTER TABLE `importation`
MODIFY `importation_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 5;
--
...
--
ALTER TABLE `moyen_expeditions`
MODIFY `moyen_expedition_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 4;
--
...
--
ALTER TABLE `port_destinations`
MODIFY `port_destination_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 3;
--
...
--
ALTER TABLE `transporteurs`
MODIFY `transporteur_id` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 6;
--
